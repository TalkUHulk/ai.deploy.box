...
USE_LITE_KERNEL(set_value, kX86, kAny, kNCHW, fp32);
USE_LITE_KERNEL(set_value, kX86, kAny, kNCHW, int32);
USE_LITE_KERNEL(set_value, kX86, kAny, kNCHW, int64);
USE_LITE_KERNEL(set_value, kX86, kAny, kNCHW, bool);
USE_LITE_KERNEL(set_value, kX86, kAny, kNCHW, double);
...
USE_LITE_KERNEL(transpose, kX86, kFloat, kNCHW, int32);
USE_LITE_KERNEL(transpose2, kX86, kFloat, kNCHW, int32);
...
USE_LITE_KERNEL(calib, kX86, kFloat, kNCHW, fp32_to_fp16);
USE_LITE_KERNEL(calib, kX86, kFP16, kNCHW, fp16_to_fp32);
...
USE_LITE_KERNEL(calib, kX86, kFloat, kNCHW, int32_to_fp16);
USE_LITE_KERNEL(calib, kX86, kFloat, kNCHW, fp16_to_int32);
...
USE_LITE_KERNEL(erf, kX86, kFloat, kNCHW, def);
