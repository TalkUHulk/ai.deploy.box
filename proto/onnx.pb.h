...
inline void NodeProto::clear_overload() {
  overload_.ClearToEmptyNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
  _has_bits_[0] &= ~0x00000010u;
}
...
inline const std::string& NodeProto::_internal_overload() const {
  return overload_.GetNoArena();
}
inline void NodeProto::_internal_set_overload(const std::string& value) {
  _has_bits_[0] |= 0x00000010u;
  overload_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), value);
}
inline void NodeProto::set_overload(std::string&& value) {
  _has_bits_[0] |= 0x00000010u;
  overload_.SetNoArena(
    &::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::move(value));
...
inline void NodeProto::set_overload(const char* value) {
  GOOGLE_DCHECK(value != nullptr);
  _has_bits_[0] |= 0x00000010u;
  overload_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), ::std::string(value));
  // @@protoc_insertion_point(field_set_char:onnx.NodeProto.overload)
}
inline void NodeProto::set_overload(const char* value, size_t size) {
  _has_bits_[0] |= 0x00000010u;
  overload_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
  // @@protoc_insertion_point(field_set_pointer:onnx.NodeProto.overload)
}
inline std::string* NodeProto::_internal_mutable_overload() {
  _has_bits_[0] |= 0x00000010u;
  return overload_.MutableNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline std::string* NodeProto::release_overload() {
  ...
  _has_bits_[0] &= ~0x00000010u;
  return overload_.ReleaseNonDefaultNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
}
inline void NodeProto::set_allocated_overload(std::string* overload) {
  ...
  overload_.SetAllocatedNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(), overload);
...
inline void FunctionProto::set_overload(const char* value, size_t size) {
  _has_bits_[0] |= 0x00000008u;
  overload_.SetNoArena(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited(),
      ::std::string(reinterpret_cast<const char*>(value), size));
